...
export class NumberingsFontWeightField {
  readonly #targetApp;
  ...
  constructor(targetApp: App) {
    ...
    this.#input = new AttributeInput('font-weight', selectedNumberings, parentDrawing);
    ...
    this.#input.onEdit = () => {
      // reposition each numbering (after editing font weight)
    ...
    this.#field.infoLink = 'https://developer.mozilla.org/en-US/docs/Web/SVG/Reference/Attribute/font-weight';
