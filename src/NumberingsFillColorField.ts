...
export class NumberingsFillColorField {
  readonly #targetApp;
  ...
  constructor(targetApp: App) {
    ...
    this.#input = new ColorAttributeInput('fill', selectedNumberings, parentDrawing);
    ...
    selectedNumberings.addEventListener('change', () => {
      this.#previousState = {};
    });
