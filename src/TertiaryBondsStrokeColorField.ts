...
export class TertiaryBondsStrokeColorField {
  readonly #targetApp;
  ...
  constructor(targetApp: App) {
    ...
    this.#input = new ColorAttributeInput('stroke', selectedTertiaryBonds, parentDrawing);
    ...
    selectedTertiaryBonds.addEventListener('change', () => {
      this.#previousState = {};
    });
